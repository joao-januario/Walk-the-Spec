...
9. Completion validation:
   ...
   - Suggest next steps: "Run `/speckit.review` to audit the code against best practices, then `/speckit.heal` to apply fixes, then `/speckit.conclude` to finalize and merge to main."
