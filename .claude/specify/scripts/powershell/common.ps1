...
function Resolve-Template {
    ...
    $base = Join-Path $RepoRoot '.claude/specify/templates'
    ...
    $presetsDir = Join-Path $RepoRoot '.claude/specify/presets'
    ...
    $extDir = Join-Path $RepoRoot '.claude/specify/extensions'
    if (Test-Path $extDir) {
