...
3. **Stop and report**: Command ends after Phase 2 planning. Report branch, IMPL_PLAN path, generated artifacts. The completion message MUST end with: "Next step: `/spec.analyze` or `/spec.implement`"
